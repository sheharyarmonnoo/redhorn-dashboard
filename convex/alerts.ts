...
/**
 * Patch the editable fields on a user-created alert. Used by the alerts page
 * Edit drawer; we don't expose this for AI insights since their content is
 * regenerated by Claude each sync.
 */
...
/**
 * Delete an alert row outright. Used for the alerts-page Delete action on
 * Handled rows so the user can prune resolved items they no longer want
