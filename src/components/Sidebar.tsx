...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-[#1a1a2e] flex flex-col z-50">
      {/* Deal Manager AI Branding */}
      <div className="p-5 border-b border-white/10">
        <div className="flex items-center gap-2.5 mb-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#4f6ef7] to-[#7c5cfc] flex items-center justify-center flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-[10px] text-[#7c9cfc] font-medium tracking-widest uppercase">AI</p>
          </div>
        </div>
        <div className="bg-white/5 rounded-lg px-3 py-2">
          <p className="text-xs font-semibold text-white">REDHORN CAPITAL</p>
          <p className="text-[10px] text-gray-400 mt-0.5">Asset Management Dashboard</p>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors ${
                active
                  ? "bg-[#4f6ef7]/20 text-[#7c9cfc] font-medium"
      ...
      <div className="p-4 border-t border-white/10">
        <p className="text-xs text-gray-500">Hollister Business Park</p>
