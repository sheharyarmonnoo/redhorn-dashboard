...
import { LayoutDashboard, Map, Table, AlertTriangle, Database, Menu, X, ChevronDown, PanelLeftClose, PanelLeftOpen, Activity, Sun, Moon, UserCircle, TrendingUp, Briefcase, Wrench } from "lucide-react";
...
const navGroups: NavGroup[] = [
  {
    label: "Overview",
    items: [
      { href: "/", label: "Meeting Dashboard", icon: LayoutDashboard },
    ],
  },
  {
    label: "Property",
