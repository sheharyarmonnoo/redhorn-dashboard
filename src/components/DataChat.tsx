    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-5 left-5 lg:left-[275px] z-50 bg-gradient-to-r from-indigo-600 to-indigo-500 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-105 cursor-pointer"
        >
      ...
      {/* Chat Panel */}
      {isOpen && (
        <div className="fixed bottom-5 left-5 lg:left-[275px] z-50 w-[380px] h-[520px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
          {/* Header */}
